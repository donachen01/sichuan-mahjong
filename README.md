...
`2.6.11` 统一了碰、杠、胡牌来源标记：碰/杠使用贴牌的天蓝色短杆小箭头，胡牌只保留更小的简洁箭头，两者均不显示来源座位文字。上家和下家胡牌结果收回各自桌面轨道，不侵占本家手牌；胡牌、暗杠和正常暗手共用稳定墨绿牌背。Android 正式包排除测试、证据、工具、文档与设计源资产，保留运行必需资源；不改变规则、计分、AI和触控合同。
